...
const RecentBooks = () => {
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-10 md:mx-20 gap-6">
            ...
            <div >
                <img className="rounded-md h-[40vh] w-full p-4 shadow-xl" src="https://i.ibb.co/JqRwm4S/event6.png" alt="" />
                <h2 className="text-center text-lg font-semibold">Xiaomi 12 Pro Is Now 12% Off </h2>
